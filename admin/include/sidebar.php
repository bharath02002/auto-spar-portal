...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
							...
							<li><a href="customer-feedback.php"><i class="menu-icon icon-tasks"></i>Customer Feedback </a></li>
						<!--	<li><a href="staff-logs.php"><i class="menu-icon icon-tasks"></i>Staff Login Log </a></li>  -->
							<li>
								<a href="logout.php">
