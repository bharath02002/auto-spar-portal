...
//unlink($dir.'/'.$pimage);
	...
	move_uploaded_file($_FILES["productimage2"]["tmp_name"],"../admin/productimages/$pid/".$_FILES["productimage2"]["name"]);
...
<head>
	...
	<title><?php echo $_SESSION['alogin']; ?>| Update Product Image</title>
...
<div class="controls">
<img src="../admin/productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> 
</div>
</div>
