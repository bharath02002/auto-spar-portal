...
<?php }
				...
				<li><a href="logout.php"><i class="icon fa fa-sign-out"></i>User Logout</a></li>
				<?php } ?>	
				</ul>
			</div><!-- /.cnt-account -->
...
<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						<a href="admin/index.php" class="dropdown-toggle" ><span class="key">Admin Login</b></a>
					<!--	<a href="staff/index.php" class="dropdown-toggle" ><span class="key">Staff Login</b></a>
